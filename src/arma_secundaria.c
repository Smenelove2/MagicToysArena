...
ArmaSecundaria gArmasSecundarias[] = {
    {
        ...
        .status = "Dano: 35/s | Duracao: 3s | Raio: 220 | Recarga: 7s",
    ...
    },
    {
        ...
        .status = "Dano: 5 | Alcance: 260 | Recarga: 1,5s",
        .tipo = TIPO_ARMA_SECUNDARIA_CONE_EMPURRAO,
        .dano = 5.0f,
        .raioOuAlcance = 260.0f,
        .duracao = 0.2f,
        .tempoRecarga = 1.5f,
    ...
    },
    {
        ...
        .status = "Duracao: 2s | Raio: 40 | Recarga: 5s",
    ...
    },
    {
        ...
        .status = "Duracao: 7s | Raio: 200 | Recarga: 7s",
